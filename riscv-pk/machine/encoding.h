...
#define TSTATUS_UI          0x00020000 
/* ut interrupted bit, prevents enclave from running. This bit is set by hardware or software and cleared by software */
